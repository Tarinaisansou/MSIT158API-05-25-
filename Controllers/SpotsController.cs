...
namespace MSIT158API.Controllers
{
    ...
    public class SpotsController : ControllerBase
    {
        ...
        [HttpPost]
        public  async Task<ActionResult<SpotsPagingDTO>> GetSpotsBySearch([FromBody] SearchDTO searchDTO)
        {
            //根據分類編號搜尋景點資料
            ...
            var categorydatas = _context.Categories;
            ...
            spotsPaging.categories = categorydatas;
